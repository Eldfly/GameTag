...
urlpatterns = [
    ...
    path('forum/<slug:forum_slug>/topic/<int:topic_id>/threads/<int:pk>/delete_thread/', views.ThreadDeleteView.as_view(), name='delete_thread'),

    #url for showing all posts for a thread in a specific fourm
    path('forum/<slug:forum_slug>/topic/<int:topic_id>/threads/<int:thread_id>/', views.PostListView.as_view(), name='thread_posts'),

    #url for reply to a post in a thread
    path('forum/<slug:forum_slug>/topic/<int:topic_id>/threads/<int:thread_id>/reply/', views.reply_thread, name='reply_thread'),
